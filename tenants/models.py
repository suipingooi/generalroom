...
class ViewRequest(models.Model):
    ...
    preferred_startdate = models.DateTimeField(blank=False)
    subject_message = models.TextField(blank=False)

    def __str__(self):
        return self.company_name + " " + self.viewing_date + " " + self.viewing_time
